          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-slide-in-right">
              ...
              <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
                <p>Компания SImpleLand с 2006 года производит сэндвич-панели, системы утепления фасадов и быстровозводимые здания.

Завод SImpleLand выпустил более десяти миллионов квадратных метров изделий, которые использованы при строительстве и реконструкции зданий, во всех климатических зонах России.

Поставлять  строительные материалы в таких объёмах возможно благодаря трём составляющим: высоким компетенциям сотрудников, качественным материалам и оборудованию завода SImpleLand.</p>
                <p>
