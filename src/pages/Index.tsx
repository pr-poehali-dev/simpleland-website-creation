          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-slide-in-right">
              ...
              <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
                ...
                <p>Сердце производства компании Термолэнд – итальянская линия «ROBOR». Через неё проходят листы стали и минеральноватного утеплителя, чтобы превратиться в готовые изделия. Для обеспечения полной комплектации объектов используются: итальянская линия продольно-поперечной резки металла Каму и две немецкие линии по изготовлению фасонных элементов Шрёдер.</p>
              </div>
