  ...
  const products = [
    {
      ...
      description: 'Быстровозводимые склады от 500 до 10000 м²',
      features: ['Срок строительства 2-4 месяца', 'Высота до 12 метров', 'Любая планировка'],
      icon: 'Warehouse'
    },
    {
      title: 'Производственные здания',
      description: 'Современные цеха и производственные помещения',
      features: ['Энергоэффективность', 'Прочная конструкция', 'Быстрый монтаж'],
      icon: 'Factory'
    },
    {
    ...
    },
    {
      ...
      description: 'Комфортные офисные пространства',
